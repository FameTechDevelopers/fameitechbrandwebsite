...
function LogoDesign() {
  return (
    <main className="size-full">
      <div className='bg-[url("/public/images/heroBanner.webp")] bg-no-repeat bg-cover bg-center'>
        <Navbar />
        <HeroSection />
      </div>
      <div className='size-full bg-[url("/public/images/2ndbg.webp")] bg-no-repeat bg-cover bg-center'>
