          ...
          <div className="container">
            <div className="grid grid-cols-12 md:gap-6 gap-2">
              ...
              <div className="md:col-span-6 col-span-12">
                <img
                  src="https://cdn-ikpnlcj.nitrocdn.com/weiDAkCcNhepGRAFGfsIHxqnlniULSbJ/assets/images/optimized/rev-11a753c/fameitech.com/wp-content/uploads/elementor/thumbs/online-strategy-media-marketing-icons-2023-11-27-05-20-22-utc-1-scaled-ql9onvjwqtpxdvkvadnags814vgablghku9iwtcvr4.jpg"
          ...
          <div className="container mt-10">
            ...
            <div className="grid grid-cols-12 mt-6 max-lg:gap-2">
              <div className="lg:col-span-4 md:col-span-6 col-span-12 flex items-center flex-col h-full w-full bg-gray-200 py-6 px-10 gap-6">
                <img
                  src="https://cdn-ikpnlcj.nitrocdn.com/weiDAkCcNhepGRAFGfsIHxqnlniULSbJ/assets/images/optimized/rev-11a753c/fameitech.com/wp-content/uploads/2024/03/premium-1.png"
                  alt=""
                  className="w-1/3"
                />
              ...
              <div className="lg:col-span-4 md:col-span-6 col-span-12 flex  items-center flex-col h-full w-full bg-white py-6 px-10 gap-6">
                <img
                  src="https://cdn-ikpnlcj.nitrocdn.com/weiDAkCcNhepGRAFGfsIHxqnlniULSbJ/assets/images/optimized/rev-11a753c/fameitech.com/wp-content/uploads/2024/03/3-2.png"
                  alt=""
                  className="w-1/3"
                />
              ...
              <div className="lg:col-span-4 md:col-span-6 col-span-12 flex items-center flex-col h-full w-full bg-white py-6 px-10 gap-6">
                <img
                  src="https://cdn-ikpnlcj.nitrocdn.com/weiDAkCcNhepGRAFGfsIHxqnlniULSbJ/assets/images/optimized/rev-11a753c/fameitech.com/wp-content/uploads/2024/03/3-1-1.png"
                  alt=""
                  className="w-1/3"
                />
              ...
              <div className="lg:col-span-4 md:col-span-6 col-span-12 flex items-center flex-col h-full w-full bg-gray-200 py-6 px-10 gap-6">
                <img
                  src="https://cdn-ikpnlcj.nitrocdn.com/weiDAkCcNhepGRAFGfsIHxqnlniULSbJ/assets/images/optimized/rev-11a753c/fameitech.com/wp-content/uploads/2024/03/quick-delivery-1.png"
                  alt=""
                  className="w-1/3"
                />
