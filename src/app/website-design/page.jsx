        ...
        <div className="web-hero flex h-full justify-center md:items-center">
          <div className="container z-30 max-md:mt-10">
            ...
            <h1 className="xl:text-6xl lg:text-5xl text-4xl lh">
              Custom 
                <span className="text-primary italic"> Web Design </span> Services That <span className="text-primary italic"> Boosts </span> Your Brand <span className="text-primary italic"> Revenue </span>
              </h1>
...
<div className='text-white text-lg max-md:text-center max-md:px-4'>
    <h1 className="lg:text-5xl text-4xl lh font-semibold text-white"><span className="text-primary italic"> Results-Oriented </span> Website Solutions</h1>

    <p className='mt-2'>Fameitech's custom website design and development services allow for a seamless transition into the digital world. As a leading innovator in the field, we provide comprehensive digital business solutions for businesses of all kinds. Our bespoke solutions are designed to suit your specific needs and exceed your expectations. Our expertise covers a wide range of needs, including creating polished and professional websites for small businesses and building strong E-commerce platforms.</p>
...
<div className="mt-6 grid grid-cols-12 lg:px-2.5 px-1 w-full h-full gap-2">
    ...
    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={pinkLaptop} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>

    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={blackLaptop} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>
    
    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={whiteLaptop} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div> 
    
     <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={macbook} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>

    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={magazine} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>

    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={magazines} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>
   
    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={yellowLaptop} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>
    ...
    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={imac} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>
    ...
    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={purpleLaptop} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>

    <div className="xl:col-span-3 md:col-span-4 col-span-6 relative w-full h-full afterBlack">
        <Image src={brownMac} width={1000} height={1000}  className="w-full h-80 object-cover"/>
    </div>
