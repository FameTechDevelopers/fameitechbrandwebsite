...
import ShadeTabs from "@/components/ShadeTabs";
      ...
      <div class="tailored-container">
        ...
        <div className=" flex tailored-packages justify-center items-center p-2">
          <div className="container py-8 z-30">
            ...
            <div className="lg:w-[100%] mx-auto mt-8 text-black">
        <ShadeTabs
          title1={"Logo Design"}
          title2={"Website Design"}
          title3={"Vdeo Animation"}
          title1Content={<PricingCard pricing={logo}/>}
          title2Content={<PricingCard pricing={logobranding} />}
          title3Content={<PricingCard pricing={video} />}
