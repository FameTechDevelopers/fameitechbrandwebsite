              ...
              <div className='flex z-[9999]  flex-col justify-center items-center space-y-10 px-6 py-10'>
                ...
                <p>
                  ...
                  >
                    ...
                    <span className='text-6xl md:text-8xl font-bold'>{item.price}</span>
                  </span>
                </p>
                ...
                <div className='flex flex-col space-y-2 md:space-y-0 lg:flex-row lg:space-x-12  *:font-bold *:text-sm '>
                  <a href="#name_field" className='bg-gradient-to-t  transition-all duration-300 font-poppins  from-dark_blue to-sec_blue hover:bg-gradient-to-t hover:from-cyan-900 hover:to-cyan-600 shadow-[2px_2px_40px_1px_rgba(230,81,108,0.5)] hover:shadow-[2px_2px_40px_20px_rgba(3,167,211,0.2)]  px-6 py-3 rounded-full '>
                    Order Now
                  </a>
