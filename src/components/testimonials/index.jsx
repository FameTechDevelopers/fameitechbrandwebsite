  ...
  return (
    <div className='py-10 flex justify-center items-center flex-col bg-gray-100 h-full w-full'>
      <div className='text-center'>
        <h1 className='text-5xl font-semibold'>Our Services Are <span className='text-primary italic'> Cherished </span> By All!</h1>
        <p className='w-full font-medium my-2.5'>We have served hundreds of brands, and look at what they have to say for us.</p>
      </div>
...
<Image width={100} height={100} src={blackQuote} alt="quote" className='w-14' />
 ...
 :
<Image width={100} height={100} src={whiteQuote} alt="quote" className='w-14' />
            }

<p className='text-lg italic text-center my-6 font-medium'>{test.text}</p>
...
<FaStar color='#ff7400'/>
          ...
          <div className="rounded-full absolute -bottom-5 flex justify-center items-center w-full flex-col">
            <Image width={100} height={100} src={test.img} className='w-20 rounded-full p-1 bg-white'/>
