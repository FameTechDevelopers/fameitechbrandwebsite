...
export default function ThankYouMoadal({open, setOpen}) {
                ...
                <div className="bg-[#fff0e4] px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-6 pt-4 flex justify-center items-center flex-col w-full sm:ml-4 sm:mt-0">
                      <Dialog.Title as="h3" className="text-4xl text-center font-semibold leading-6 text-[#6a5acd]">
                        Thank You !
                      </Dialog.Title>
...
<div className="mt-5 sm:w-1/3 w-1/2 bg-primary p-1 rounded-full">
                      ...
                      <div className="mt-10">
                        <p className="font-semibold text-lg text-gray-500 text-center">
                          We wil lget in touch with you soon
                        </p>
                      </div>

<p className="mt-6 text-gray-700 font-semibold">Redirecting You in {count}... </p>
