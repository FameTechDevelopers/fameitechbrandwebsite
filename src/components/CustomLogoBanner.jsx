        ...
        <div className="bg-CustomLogo py-12">
          <div className="max-w-[1300px] mt-6 px-12 mx-auto py-10">
            <div className="lg:pl-[30px] pt-10 lg:ml-10 ">
              <h2 className=" text-[#fff] font-oswald-light  text-center font-bold text-[2.2rem] md:text-[3.2rem] md:leading-[70px] leading-[50px] capitalize ">
                Get Your Custom Logo Designed in just
              </h2>
              <div className="pt-10 flex justify-center items-center gap-4  ">
                <button onClick={maximizeChat} className=" uppercase text-[#fff] bg-[#FE7524] md:px-8 px-4 py-2 rounded-full shadow-stone-400 ">
                  LIVE CHAT
                </button>
                <LiveChat visibility={visibility} setVisibility={setVisibility}  />
                <a href="tel:tel:+18722333612" className="uppercase text-[#000000] bg-[#ffffff] md:px-8 px-4 py-2 rounded-full shadow-stone-400 ">
                  Call now
                </a>
